...
var url;
	...
	function shenheYonghu(){
		var selectedRows=$("#dg").datagrid('getSelections');
		if(selectedRows.length!=1){
			$.messager.alert("系统提示","请选择一条要通过的数据！");
			return;
		}
		var row=selectedRows[0];
		url="../addYonghu?yonghuId="+row.yonghuId;
...
<!--startprint-->
	<table id="dg" title="用户信息" class="easyui-datagrid" fitColumns="true"
	 pagination="true" url="../getYonghus?yonghuType1=0" fit="true" toolbar="#tb">
		<thead>
			<tr>
	...
	<div id="tb">
		<div>
			<a href="javascript:shenheYonghu()" class="easyui-linkbutton" iconCls="icon-edit" plain="true">通过</a>
		</div>
		<div>
