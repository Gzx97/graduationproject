...
<!--startprint-->
	 ...
	 pagination="true" url="../getGonggaos" fit="true" toolbar="#tb">
		<thead>
			<tr>
				...
				<th field="gonggaoImg" width="20" formatter="formatChakan">查看</th>
				<th field="gonggaoImgName" width="20" formatter="formatXiazai">下载</th>
			</tr>
		</thead>
	</table>
	...
	<div id="tb">
		<div>
			...
			<a href="javascript:shangchuanGonggao()" class="easyui-linkbutton" iconCls="icon-add" plain="true">上传附件</a>
			<a href="javascript:doPrint()" class="easyui-linkbutton" iconCls="icon-add" plain="true">打印</a>
		</div>
		<div>
