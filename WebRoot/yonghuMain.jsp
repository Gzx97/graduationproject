...
<div class="layui-layout layui-layout-admin"> <!-- 添加skin-1类可手动修改主题为纯白，添加skin-2类可手动修改主题为蓝白 -->
    ...
    <div class="layui-header my-header">
        ...
        <div class="my-header-btn">
            <button class="layui-btn layui-btn-small btn-nav">二</button>
        </div>
        ...
        <div class="layui-side-scroll">
            ...
            <ul class="layui-nav layui-nav-tree" lay-filter="side-main">
               <li class="layui-nav-item  layui-nav-itemed">
                ...
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon"></i>图片信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="yonghu/shangpin0.jsp"><i class="layui-icon"></i>图片信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon"></i>视频信息</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="yonghu/shangpin1.jsp"><i class="layui-icon"></i>视频信息</a></dd>
                    </dl>
                </li>
                <li class="layui-nav-item">
                    <a href="javascript:;"><i class="layui-icon"></i>收藏中心</a>
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:;" href-url="yonghu/spchu.jsp"><i class="layui-icon"></i>素材收藏</a></dd>
                    </dl>
                </li>
            </ul>
